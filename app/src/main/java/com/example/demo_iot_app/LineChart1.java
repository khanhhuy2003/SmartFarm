...
//                        Log.e("LineChart1", "Invalid temperature format", e);
//                    }
//                }
//            }
//
...
public class LineChart1 extends AppCompatActivity {
    private static final String KEY_LINE_ENTRIES = "lineEntries";
    private MQTTHelper mqttHelper;
    private LineChart lineChart;
    private LineData lineData;
    private LineDataSet lineDataSet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            ArrayList<Entry> savedEntries = savedInstanceState.getParcelableArrayList(KEY_LINE_ENTRIES);
            if (savedEntries != null) {
                lineEntries.addAll(savedEntries);
                updateChart();
            }
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        // Save the current data entries of the line chart
        outState.putParcelableArrayList(KEY_LINE_ENTRIES, new ArrayList<>(lineEntries));
    }
    private void updateChart() {
        // Update the line chart with the restored data entries
        lineDataSet.notifyDataSetChanged();
        lineData.notifyDataChanged();
        lineChart.notifyDataSetChanged();
        lineChart.invalidate();
