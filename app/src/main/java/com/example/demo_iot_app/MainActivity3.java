...
public class MainActivity3 extends AppCompatActivity {
    ...
    private static final float TEMPERATURE_THRESHOLD = 70.0f; // Set your threshold value here
    ...
    private void sendTemperatureAlert(float temperature) {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setContentText("The temperature is " + temperature + "°C, which is above the threshold!")
