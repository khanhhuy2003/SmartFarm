...
public class mixer2 extends AppCompatActivity {
...
//                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mixer2);
        ...
        mixer2Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String numberStr = mixer2.getText().toString();
                ...
                if (!numberStr.isEmpty()) {
                    ...
                    Toast.makeText(mixer2.this, "Please enter a number", Toast.LENGTH_SHORT).show();
                }
            }
