...
public class mixer3 extends AppCompatActivity {
...
//                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mixer3);
        ...
        mixer3Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String numberStr = mixer3.getText().toString();
                ...
                if (!numberStr.isEmpty()) {
                    ...
                    Toast.makeText(mixer3.this, "Please enter a number", Toast.LENGTH_SHORT).show();
                }
            }
